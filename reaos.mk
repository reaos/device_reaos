...
TARGET_VENDOR_PROP += device/reaos/reaos.prop
...
DEVICE_MANIFEST_FILE += device/reaos/android.hardware.bluetooth@1.1.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/reaos-removed-permissions.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/reaos-removed-permissions.xml \
    $(LOCAL_PATH)/init.reaos.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.reaos.rc \
...
$(call inherit-product, vendor/reaos/vendor.mk)

$(call inherit-product, device/reaos-prebuilts/prebuilts.mk)
